              ...
              <div className="w-full space-y-2.5">
                {[
                  ...
                  >
                    ...
                    <span style={{ color: checklistItems[i] ? '#e1e2ec' : '#8c909f' }} className="text-sm">
                      {item}
                    </span>
                  </div>
                ))}
            ...
            <div className="p-6 space-y-4">
              ...
              >
                ...
                <span className="text-[#8c909f] text-xs">
                  Maksimal 5 file. Bukti ini akan terlihat oleh admin saat verifikasi.
                </span>
